...
import com.kk.community.util.CookiesUtil;
...
public class LoginTicketIntercepter implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (ticket!=null){
           ...
           // System.out.println(loginTicket+"---preHandle ticket");
            //检查凭证是否有效
            if (loginTicket!=null&&loginTicket.getStatus()==0&&loginTicket.getExpired().after(new Date())){
                User user = userService.findUserById(loginTicket.getUserId()); //从redis缓存中查找
                //System.out.println(user.toString()+"---preHandle");
                //在本次请求中持有用户
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        ...
        if (user!=null && modelAndView!=null){
            //System.out.println(user.toString()+"--postHandle");
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) throws Exception {
        ...
        //System.out.println("user被我清除了---来自过滤器的afterCompletion");
    }
}
